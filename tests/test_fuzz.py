...
from server import query_crosswalk


# Strategy for the primary description-like string argument.
framework_arg = st.text(min_size=0, max_size=2000)


@given(arg=framework_arg)
def test_query_crosswalk_never_unhandled_exception(arg):
